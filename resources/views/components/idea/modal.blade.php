    ...
    >
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                @if($idea->image_path)
                    <div class="space-y-2">
                        <img src="{{ asset('storage/' . $idea->image_path) }}" alt="Image Idea" class="w-full h-auto object-cover rounded-lg">
                        <button type="submit" class="btn btn-outlined h-10 w-full" form="delete-image-form">Remove Image</button>
                    </div>
                @endif
                <input
                        type="file"
